...
const MOBILE_NAV: NavItem[] = [...NAV_MAIN.slice(0, 4), NAV_FOOTER[0]];
...
export function Sidebar({ email }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* ── Mobile bottom nav ── */}
      <nav className="lg:hidden fixed bottom-0 inset-x-0 z-40 flex h-16 items-center border-t border-border/60 bg-card/95 backdrop-blur-xl px-1">
        {MOBILE_NAV.map((item) => (
